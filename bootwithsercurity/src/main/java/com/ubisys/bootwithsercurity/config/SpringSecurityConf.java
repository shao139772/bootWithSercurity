package com.ubisys.bootwithsercurity.config;

import com.ubisys.bootwithsercurity.common.sercurity.*;
...
//        auth.authenticationProvider(provider);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/sys/sysUser/test").permitAll()//定义哪些URL需要被保护、哪些不需要被保护
                .antMatchers("/sys/sysUser/test2").authenticated()
